      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Match your transactions to your bank account</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Enter the ending balance from your bank account</p>
          </div>
...
function SummaryBar({ beginningBalance, clearedDeposits, clearedPayments, clearedBalance, statementBalance, difference }) {
  ...
  const items = [
    ...
    { label: 'Account Balance', value: formatCurrency(statementBalance), color: 'text-gray-900', bold: true },
  ]
